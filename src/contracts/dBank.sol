...
contract dBank {
  ...
  //add mappings and add events for deposit and withdraw
  ...
  // add mapping and event for borrow and payoff 
  ...
  function deposit() payable public {
    ...
    //1.increase msg.sender ether deposit balance
    etherBalanceOf[msg.sender] = etherBalanceOf[msg.sender] + msg.value;
    //2.start msg.sender hodling time
    depositStart[msg.sender] = depositStart[msg.sender] + block.timestamp;
    //3.set msg.sender deposit status to true
